...
(function () {
  ...
  //封装一个函数render 里面设置sup当前小li高亮还有对应品牌的渲染
  function render (that) {
    that.addClass("active").siblings().removeClass();

    //通过当前li获取sub模块内容
    //hotData[$(this).index()].brands
    // var subHTML = `<li><span></span><span> <s class="icon-up"></s></span></li>`;
    var subHTML = '';
